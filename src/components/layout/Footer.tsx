        ...
        <div className="grid grid-cols-1 gap-10 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <Link href="/" className="inline-flex items-center gap-3 rounded-2xl border border-border bg-background/80 px-4 py-3">
              <Image src="/logo.png" alt="Vimanasa Services LLP" width={150} height={48} className="h-10 w-auto object-contain" />
            </Link>
            <p className="mt-5 max-w-xl text-sm leading-relaxed text-muted-foreground">
              Vimanasa Services LLP helps organizations scale with reliable manpower outsourcing, telecom execution, and digital technology services.
            </p>
